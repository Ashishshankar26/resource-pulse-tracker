...
- Node.js with Express routing, middleware, sessions, validation, API versioning, and file I/O
...
- Backend syllabus: Express app, middleware, HTTP services, CRUD, session usage, validation, JSON-based persistence, versioned REST API, Socket.IO
